...
ZO_CreateStringId("SI_MAP_INFO_WAYSHRINES_CATEGORY_FAVOURITES","Character's Favourites")
ZO_CreateStringId("SI_MAP_INFO_WAYSHRINES_CATEGORY_ACCOUNT_FAVOURITES","Player's Favourites")
